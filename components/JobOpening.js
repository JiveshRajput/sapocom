...
export default function JobOpening({ title, department, place }) {
  ...
  return (
    <div class="flex justify-between rounded-lg bg-white p-6 shadow-md transition-transform hover:-translate-y-1 hover:transform hover:border-blue-400 hover:shadow-xl">
      <div class="flex-col">
