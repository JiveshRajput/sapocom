...
export const degreesOptionList =  ['Associate of Applied Science (AAS)', 'Associate of Arts (AA)', 'Associate of Science (AS)', 'Bachelor of Architecture (BArch)', 'Bachelor of Arts (BA)', 'Bachelor of Business Administration (BBA)', 'Bachelor of Commerce (BCom)', 'Bachelor of Computer Applications (BCA)', 'Bachelor of Computer Science (BCS)', 'Bachelor of Education (BEd)', 'Bachelor of Engineering (BE)', 'Bachelor of Fine Arts (BFA)', 'Bachelor of Music (BMus)', 'Bachelor of Nursing (BN)', 'Bachelor of Science (BSc)', 'Bachelor of Science in Engineering (BScEng)', 'Bachelor of Social Work (BSW)', 'Bachelor of Technology (B Tech)', "Bachelor's Degree", 'Doctor of Dental Medicine (DMD)', 'Doctor of Medicine (MD)', 'Doctor of Pharmacy (PharmD)', 'Doctor of Philosophy (PhD)', 'Doctor of Veterinary Medicine (DVM)', 'High School', 'Master of Arts (MA)', 'Master of Business Administration (MBA)', 'Master of Computer Applications (MCA)', 'Master of Engineering (MEng)', 'Master of Fine Arts (MFA)', 'Master of Public Health (MPH)', 'Master of Science (MSc)', 'Master of Technology (M Tech)', "Master's Degree" , "Other"];
export const sidebarList = {"Dashboard":"/admin/dashboard","Jobs":"/admin/jobs","Blogs":"/admin/blogs","Slides":"/admin/slider-images"};